...
- When a runtime output instruction says the runtime will persist your final response, return the complete artifact in that response; lack of a write tool is not a reason to contact the supervisor.
